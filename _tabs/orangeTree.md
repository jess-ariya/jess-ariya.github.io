...
<div class="project-hero-image" style="text-align: center;">
  <img src="/assets/img/projects/orangeTree/bg_draft_pixelated.png" alt="Creating pixel art in Figma" class="project-image">
  <p><em>Fig 2: Creating pixel art in Figma</em></p>
</div>

<div class="project-hero-image" style="text-align: center;">
  <img src="/assets/img/projects/orangeTree/bg_draft.png" alt="Background draft" class="project-image">
  <p><em>Fig 3: Background draft</em></p>
</div>

<div class="project-hero-image" style="text-align: center;">
  <img src="/assets/img/projects/orangeTree/draft_compelte.png" alt="Draft of component placement in the background" class="project-image">
  <p><em>Fig 4: Draft of component placement in the background</em></p>
</div>

In this world, each project is represented by a **basket**,  and a corresponding **Tree** on the hill (yes, it’s redundant and I shall work on this aspect). The state of your tasks is reflected in the life cycle of the tree: 
...
The final rewarding part of the “Orange Tree” metaphor is the **Harvest**. When a project is completed, the tree is transformed into a **dessert** made from the oranges harvested during the process. These earned treats are displayed on a picnic blanket below the hill, serving as a visual trophy of your productivity (Fig 4).
...
## The Progress
As of writing, I am on Day 3 of the project. While there is still plenty of room for improvement and a lot more I want to build, I am happy with how much fun I am having and how quick this vision is coming to life. 
<br>
